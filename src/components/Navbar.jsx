...
const Navbar = () => {
  ...
  <div className="flex max-w-screen-xl mx-auto w-full">
    <div className="flex flex-wrap items-center lg:gap-y-2 gap-4 w-full">
      <Link to={"/"} className="max-sm:hidden"><img src="logo.png" alt="logo" className="w-36" />
      </Link>
      <div id="collapseMenu" className="lg:ml-6 max-lg:hidden lg:!block max-lg:before:fixed max-lg:before:bg-black max-lg:before:opacity-50 max-lg:before:inset-0 max-lg:before:z-50">
        ...
        <ul className="lg:flex lg:gap-x-3 max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50">
          ...
          <li className="max-lg:border-b max-lg:py-3 px-3"><Link  className="text-[#333] hover:text-[#ff523b] text-[19px] block font-semibold">About</Link></li>
          <li className="max-lg:border-b max-lg:py-3 px-3"><Link  className="text-[#333] hover:text-[#ff523b] text-[19px] block font-semibold">Contact</Link></li>
          <li className="max-lg:border-b max-lg:py-3 px-3"><Link  className="text-[#333] hover:text-[#ff523b] text-[19px] block font-semibold">Account</Link></li>
        </ul>
      </div>
      <div className="flex items-center gap-x-6 gap-y-4 ml-auto">
        ...
        <div className="flex items-center sm:space-x-8 space-x-6">
          ...
          <button className="max-lg:hidden px-4 py-2 text-sm rounded-full text-white border-2 border-[#ff523b] bg-[#ff523b] hover:bg-[#ff452db2]">Sign
            In</button>
