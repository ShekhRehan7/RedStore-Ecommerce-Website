...
const Footer = () => {
  return (
    <>
   <footer className="bg-[#070404] pt-12 pb-6 px-10 font-[sans-serif] tracking-wide mt-[300px] ">

  <div className="max-w-screen-xl mx-auto">
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
      <div className="lg:flex lg:items-center">
        <a href="javascript:void(0)">
          <img src="logo-white.png" alt="logo" className="w-48" />
        </a>
      </div>
      <div className="lg:flex lg:items-center">
    ...
    <p className="text-gray-300 text-sm mt-10">© Red Store. All rights reserved.
    </p>
  </div>
</footer>
